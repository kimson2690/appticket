...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
        <h2 style="color: #333; margin-top: 0;">Nouvelle commande reçue !</h2>
        
        <p>Bonjour,</p>
        
        <p>Vous avez reçu une nouvelle commande chez <strong>{{ $restaurantName }}</strong> !</p>
        
        <div style="background-color: white; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #f97316;">
            <p style="margin: 10px 0;">
                <strong>👤 Client :</strong> {{ $employeeName }}
            </p>
            
            <h3 style="margin-top: 15px; color: #f97316;">Détail de la commande</h3>
        ...
        <p>Veuillez vous connecter à AppTicket pour <strong>valider ou rejeter</strong> cette commande.</p>
